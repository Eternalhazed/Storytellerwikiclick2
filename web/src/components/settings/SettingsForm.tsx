      ...
      {!state.use_ctc && (
        <Fieldset legend="Transcription settings">
          <Box className="mb-3 text-sm opacity-70">
            ...
            <p>
              This is by far the most resource-intensive phase of the process.
              By default, Storyteller will attempt to run the transcription job
          ...
          {state.transcription_engine === "whisper.cpp" && (
            <>
              ...
              <Box className="text-sm opacity-70">
                <p>
                  You can also specify which Whisper model Storyteller should
                  use for transcription. The default (tiny) is sufficient for
                  most English books. For books with many uncommon words, or in
                  languages other than English, you may need to try larger
          ...
          {state.transcription_engine === "deepgram" && (
            <>
              ...
              <TextInput
                ...
                description={
                  <>
                    Can be any model the server supports, like{" "}
                    <Code>nova-3</Code>, <Code>nova-2</Code>,<Code>nova</Code>,{" "}
                    <Code>enhanced</Code>, <Code>base</Code> or{" "}
                    <Code>whisper</Code> (see model list{" "}
                    <a
        ...
        <Fieldset legend="Parellelization settings">
          <Box className="mb-3 text-sm opacity-70">
            <p>
              ...
              Whisper’s transcription engine has diminishing returns on
              multi-core processing for a single file.
            </p>
            <p>
              However, since Storyteller splits input audio into multiple
              tracks, it’s possible to run transcoding and transcription on
